...
For example, if a student gets A, B, A, F, D, and C for six courses, the units for these six courses are 3, 1, 3, 3, 1, and 3 respectively, then the sGPA is: 
$\frac{4*3 + 3*1 + 4*3 + 0*3 + 1*1 + 2*3}{3 + 1 + 3 + 3 + 1 + 3} = 2.43$
